...
const Facts = (props) => {
    ...
    var factsArray = [
        ...
        {name: 'Dimension', value: `${NABOR_LotFrontage} X ${NABOR_LotLeft} X ${NABOR_LotBack} X ${NABOR_LotRight} Approx`},
        ...
        {name: 'Garage', value: GarageYN ? "Yes" : "No"},
        {name: 'Attached Garage', value: AttachedGarageYN ? "Yes" : "No"},
        {name: 'Carport', value: CarportYN ? "Yes" : "No"},
